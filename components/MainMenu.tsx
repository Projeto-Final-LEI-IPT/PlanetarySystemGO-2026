          ...
          {!showDistances ? (
            ...
            <>
              ...
              <TouchableOpacity style={styles.menuButton} onPress={() => handleStartGame(1)}>
                <Icon name="resize-outline" size={22} color="#FFFFFF" style={styles.icon} />
              ...
              <TouchableOpacity style={[styles.menuButton, {marginTop: 20, backgroundColor: '#666'}]} onPress={() => setShowDistances(false)}>
